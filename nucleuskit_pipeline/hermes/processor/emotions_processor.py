...
from nucleuskit_pipeline.hermes.classifier.inference import TwoStageClassifier
from nucleuskit_pipeline.hermes.classifier.realtime import StreamingEMGClassifier
...
def _classifier_dir():
    return path.normpath(
        path.join(path.dirname(path.abspath(__file__)), "..", "classifier", "weights")
    )
