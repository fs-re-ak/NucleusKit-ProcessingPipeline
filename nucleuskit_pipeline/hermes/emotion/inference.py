"""
Two-stage classifier inference — ModelV11.

V11 extends the V10 TwoStageClassifier with an artefact-rejection gate that
...
V11 also supports an optional **post-artefact cooldown**: when an artefact
...
-----
  ...
  clf = TwoStageClassifier.load("data/features/2026-03-21_ModelV11/classifier")
...
class TwoStageClassifier:
    ...
    Gate (V11)  — AVG_RMS pre-check before any LDA inference.
    ...
    def load(
        ...
        classifier_dir:
            ...
            Optional V11 file: artefact_config.json (gate disabled if absent).
        cooldown_windows:
